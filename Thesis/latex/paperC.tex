...
%A method for finding initial guesses for the solver is described in \ref{sec:stokes}. \ref{sec:implementation} contains a schematic of program and a description of its workflow.
...
%\caption{\small Graph of error estimates given in \autoref{Ben_disp_rel}ref{t2}.}
%\label{L2convergence}
%\end{figure} 
%%%%%%%%%===========%%%%%%%%%%%%%%%
...
\subsubsection{Termination of the waveheight-velocity bifurcation curve of the Whitham equation.}
\label{sec-W-term}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%===========%%%%%%%%%%%%%%%
\begin{itemize} % chktex 9 chktex 10
...
From the data given in the \ref{t1}, one can deduce that for solutions with minimum speed 
