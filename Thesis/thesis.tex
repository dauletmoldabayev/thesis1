...
%
\title{
{\fontsize{28}{30}\usefont{OT1}{phv}{bc}{n}\selectfont Modeling of heat transfer in porous media in the context of geothermal energy extraction}
	\author{
	\textbf{Carina Bringedal}\vspace{3cm}\\
...
\include{MFramwork_v2}
\include{Convection_v2}
\include{PoreScale}
\include{NFramework}
